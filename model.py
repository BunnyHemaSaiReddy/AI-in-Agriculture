...
language_codes = {
    ...
    "Russian": "ru", "Italian": "it", "Dutch": "nl", "Bengali": "bn", "Punjabi": "pa", 
    "Greek": "el", "Turkish": "tr", "Vietnamese": "vi", "Hebrew": "he", "Swedish": "sv", 
    "Danish": "da", "Finnish": "fi", "Norwegian": "no", "Polish": "pl", "Czech": "cs", 
    "Thai": "th", "Malay": "ms", "Indonesian": "id", "Tamil": "ta", "Telugu": "te", 
    "Marathi": "mr", "Urdu": "ur", "Persian": "fa", "Hungarian": "hu", "Romanian": "ro", 
    "Slovak": "sk", "Serbian": "sr", "Ukrainian": "uk", "Lithuanian": "lt", "Latvian": "lv", 
    "Estonian": "et", "Tagalog": "tl", "Swahili": "sw", "Afrikaans": "af", "Sinhala": "si"
}

with col2:
    selected_language = st.selectbox("Select Language", list(language_codes.keys()))
...
if uploaded_image:
    ...
    disease_description = re.sub(r'[^\w\s,.!?]', '', disease_description)
    disease_audio_base64 = text_to_speech_base64(disease_description, selected_language_code)
    disease_audio_bytes = base64_to_bytes(disease_audio_base64)
    
    st.audio(disease_audio_bytes)
    ...
    """, unsafe_allow_html=True)
    remedies_response = re.sub(r'[^\w\s,.!?]', '', remedies_response)
    remedies_audio_base64 = text_to_speech_base64(remedies_response, selected_language_code) 
    
    remedies_audio_bytes = base64_to_bytes(disease_audio_base64)
    st.audio(remedies_audio_bytes)
st.markdown("""
            <hr><br><br>
                <br>
                """, unsafe_allow_html=True)
